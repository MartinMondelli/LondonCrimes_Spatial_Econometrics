...
```{r}
london_area <- areas[areas$`NUTS1 Region` == 'London', ]
...
police_clean_ppp$gdp_hab <- raster::extract(population_raster, points_sp)
...
-   For each extra unit of GDP/habitant, the intensity of crime is reduced by -2.989723e-04
